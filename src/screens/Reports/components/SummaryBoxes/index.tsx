  ...
  return (
    <View style={styles.container}>
      <View style={[styles.box, { borderColor: "#4ade80", backgroundColor: "rgba(74, 222, 128, 0.05)" }]}>
        <Text style={[styles.value, { color: "#4ade80" }]}>{data.totalManutencoesPreventivas}</Text>
      ...
      <View style={[styles.box, { borderColor: "#f87171", backgroundColor: "rgba(248, 113, 113, 0.05)" }]}>
        <Text style={[styles.value, { color: "#f87171" }]}>{data.totalManutencoesCorretivas}</Text>
      ...
      <View style={[styles.box, { borderColor: "#60a5fa", backgroundColor: "rgba(96, 165, 250, 0.05)" }]}>
        <Text style={[styles.value, { color: "#60a5fa" }]}>R$ {data.valorTotalPreventivas.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</Text>
        <Text style={[styles.label, { color: "#60a5fa" }]}>Custos{"\n"}Preventivos</Text>
      </View>
    </View>
  );
}
